<?php
// Include = inclut là on lui dit (si le chemin est faux, il fait juste un avertissement et continue le code)
// Include_once = comme include mais si le include est déjà inclut quelque part, il l'ignore et ne le chargera qu'une seule fois
// Require = requiert le fichier, s'il ne le trouve pas met une erreur ET coupe le reste du code
// Require_once = pareil que require et ne l'incluera qu'une seule fois
